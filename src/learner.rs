...
impl Learner {
    ...
    pub fn record(&self, proposal_number: u64, round_number: u64, value: String, storage: &mut Arc<Mutex<Vec<(u64, String)>>>, txs: &Vec<Sender<Message>>, client_tx: &Sender<Message>, leader_id: u64) {
        ...
        if !storage_guard.contains(&(round_number, value.clone())) {
            ...
            self.send_stable_leader(client_tx, leader_id);
        }
    }
    ...
    fn send_stable_leader(&self, client_tx: &Sender<Message>, leader_id: u64) {
